    ...
    const getSingleProduct = async () => {
        try {
            const { data } = await axios.get(
                `https://full-stack-ecommernce-app-backend.onrender.com/api/v1/product/get-product/${params.slug}`
            );
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const { data } = axios.put(
                `https://full-stack-ecommernce-app-backend.onrender.com/api/v1/product/update-product/${id}`,
                productData
            );
            if (data?.success) {
    ...
    const handleDelete = async () => {
        try {
            ...
            const { data } = await axios.delete(
                `https://full-stack-ecommernce-app-backend.onrender.com/api/v1/product/delete-product/${id}`
            );
            ...
            <div className="container-fluid p-3">
                <div className="row">
                    ...
                    <div className="col-lg-7 col-md-8">
                        <h1 className="text-center mt-4">Update Product</h1>
                        <div className="m-1">
                            <Select
                                variant={false}
