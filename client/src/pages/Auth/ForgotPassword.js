                ...
                <div className="auth-card">
                    ...
                    <div className="auth-card__body">
                        <form onSubmit={handleSubmit} noValidate>
                            ...
                            {/* Email */}
                            <div className="auth-field">
                                {/* FIX: htmlFor links label to input */}
                                <label htmlFor="fp-email" className="auth-field__label">Email Address</label>
                                <div className="auth-field__input-wrap">
                            ...
                            {/* Secret word */}
                            <div className="auth-field">
                                <label htmlFor="fp-answer" className="auth-field__label">Secret Word</label>
                                <div className="auth-field__input-wrap">
                                    <span className="auth-field__icon" aria-hidden="true">🔑</span>
                                    <input
                                        id="fp-answer"
                            ...
                            {/* New password + strength */}
                            <div className="auth-field">
                                <label htmlFor="fp-password" className="auth-field__label">New Password</label>
                                <div className="auth-field__input-wrap">
                                    <span className="auth-field__icon" aria-hidden="true">🔒</span>
                                    <input
                                        id="fp-password"
                                ...
                                {/* Strength bars — decorative, hidden from screen readers */}
                                {newPassword && (
                                ...
                                {/* Rules checklist */}
                                <div id="fp-password-rules" className="auth-rules" role="status" aria-live="polite">
                                    {newPassword && rules.map(r => (
                                        <div
                                            key={r.id}
                                            className={`auth-rule ${r.test(newPassword) ? "pass" : "fail"}`}
                                        >
                                            <span className="auth-rule__dot" aria-hidden="true" />
                                            <span aria-hidden="true">{r.test(newPassword) ? "✓" : "✗"}</span>
                                            {" "}{r.text}
                                        </div>
                                    ))}
                                </div>
